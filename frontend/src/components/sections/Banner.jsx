    ...
    <SectionWrapper id="fixed-target" className="banner">
      ...
      >
        ...
        <p className="more-thn">
          Key<br />
          <span className="gen-yell">features</span>
        </p>
        <p className="meta-des">
          The PreFlight AI genesis NFT collection consists of <span className="ten-yell">10,000 unique, hand-curated suits</span>.<br />
